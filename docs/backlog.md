...
## Highline and Drake macOS workstream

### P0: establish a deployable Mac collector

- Inventory the macOS versions, Apple silicon/Intel mix, RMM execution account, script interpreter availability, MDM enrollment, and browser mix at Highline and Drake.
